...
//        }
        ...
        if(amount_tf.getText().equals("") || amount_tf.getText().matches("[0-9]+")== false){
    ...
    private void print_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_btnActionPerformed
        ...
        if(validation()==true){
            ...
            try{
                    ...
                    if(rs.next()){
                        JOptionPane.showMessageDialog(this,"ReceiptNo already exist");
